...
export const login = (email, password) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      "https://portfolio-builder-1iu3.onrender.com/api/v1/user/login",
      { email, password },
...
export const logout = () => async (dispatch) => {
  try {
    const { data } = await axios.get(
      "https://portfolio-builder-1iu3.onrender.com/api/v1/user/logout",
      { withCredentials: true }
    );
  ...
  (currentPassword, newPassword, confirmNewPassword) => async (dispatch) => {
    ...
    try {
      const { data } = await axios.put(
        "https://portfolio-builder-1iu3.onrender.com/api/v1/user/update/password",
...
export const updateProfile = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      "https://portfolio-builder-1iu3.onrender.com/api/v1/user/update/me",
      data,
      {
        withCredentials: true,
